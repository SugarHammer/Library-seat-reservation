...
<body class="bj" style="background: url('https://img.zcool.cn/community/01165058a2f3efa801219c779672c5.jpg@2o.jpg') no-repeat;background-position-y: 82vh;">
	<!-- header -->
	<div class="header">
		<nav class="navbar navbar-default">
			<div class="container" style="width: 72%;">
				<div class="navbar-header navbar-left wthree">
					<h1><a href="${path }/link/index.htm">Study Room<span></span></a></h1>
				</div>
				...
				<div class="header-right wthree">
					...
					<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav navbar-left cl-effect-14" style="margin-top: 30px;">
							<li><a href="${path }/link/index.htm" class="active">图书馆主页</a></li>
						...
						<button class="layui-btn layui-btn-lg layui-btn-radius layui-btn-normal"style="margin-left:10px;margin-top:40px" onclick="javascrtpt:window.location.href='${path }/logout.htm'">退出登录</button>
					...
					<ul class="rslides" id="slider3">
						<li>
							<div class="banner-textagileinfo">
								<h6 style="text-align: center">欢 迎 来 到</h6>
								<h3 style="text-align: center">图书馆预约占座系统</h3>
							</div>
						</li>
	...
	<div class="features">
		<div class="container">
			<div class="w3ls-title">
				<h3 class="agileits-title">阅览室余座</h3>
			</div>
			<div class="features-agilerow">
