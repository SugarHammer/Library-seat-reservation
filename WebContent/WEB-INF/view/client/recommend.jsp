...
<body style="background: url('https://img.zcool.cn/community/01165058a2f3efa801219c779672c5.jpg@2o.jpg') no-repeat;background-position-y: 48vh;">
	<!-- header -->
	<div class="header">
    ...
    layui.use(['table', 'form', 'layer'], function() {
        ...
        function setFormValue(obj){
	        ...
	        form.on('submit(submit)', function(massage) {
	            $.ajax({
	                url:'${path }/book/reserveBook.htm',
	                type:'post',
	                dataType:'json',
	                data:massage.field,
	                success:function (result){
	                    var returnCode = result.returnCode;
	                    if(returnCode == 300){ //添加成功
